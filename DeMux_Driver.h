...
public:
    ...
    PinState getState(uint8_t pinNumber)
    {
        ...
        S0.setState(static_cast<PinState>(pinNumber & 0b0001));
        S1.setState(static_cast<PinState>(pinNumber & 0b0010));
        S2.setState(static_cast<PinState>(pinNumber & 0b0100));
        S3.setState(static_cast<PinState>(pinNumber & 0b1000));
